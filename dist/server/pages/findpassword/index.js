...
//
//
/* harmony default export */ var findpasswordvue_type_script_lang_js_ = ({
  layout: 'none',
  components: {},
  ...
  data() {
    return {
      rules: {
        ...
        confirm: value => value === this.form.userPass || '两次输入密码不一样'
      },
      confirmPassword: '',
      form: {
        email: '',
  ...
  methods: {
    ...
    changePassword() {
      ...
      form.type = 1;
      this.$axios.post('/findPass', form).then(data => {
        this.loading = false;
        this.$router.push({
    ...
    sendVertifyCode() {
      if (this.counter > 0 || this.rules.mail(this.form.email) !== true) {
        return;
      }
    ...
    timer() {
      ...
      this.counter = 60;
      this.vertifyButtonText = `重新发送（${this.counter}s）`;
      const interval = setInterval(() => {
        // console.log(this.counter, this.vertifyButtonText)
        if (--this.counter > 0) {
          this.vertifyButtonText = `重新发送（${this.counter}s）`;
        } else {
          clearInterval(interval);
          this.vertifyButtonText = `重新发送`;
        }
      }, 1000);
    }
...
// CONCATENATED MODULE: ./pages/findpassword/index.vue?vue&type=script&lang=js&
 /* harmony default export */ var pages_findpasswordvue_type_script_lang_js_ = (findpasswordvue_type_script_lang_js_); 
...
var VForm = __webpack_require__(258);
...
var component = Object(componentNormalizer["a" /* default */])(
  pages_findpasswordvue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  injectStyles,
...
/* harmony default export */ var findpassword = __webpack_exports__["default"] = (component.exports);
